...
- [system-design.md](system-design.md) — Component architecture, data flow diagrams, file structure, and dependency table for the current sprint.
- [sprint-plan.md](sprint-plan.md) — Sprint stories with acceptance criteria, technical notes, and complexity estimates for the current sprint.
...
- [adrs/ADR-004-oidc-auth-and-persistence.md](adrs/ADR-004-oidc-auth-and-persistence.md) — Decision record covering Auth.js v5, JWT sessions, Supabase PostgreSQL, and multi-tenant isolation strategy.
