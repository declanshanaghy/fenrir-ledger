...
- [quality/test-suites/patreon/api-routes.spec.ts](quality/test-suites/patreon/api-routes.spec.ts) — 29-test Playwright suite: AC-1..AC-5 route existence, auth enforcement, callback validation, webhook HMAC, edge cases
...
- [page.tsx](development/frontend/src/app/page.tsx) — Dashboard layout updated: flex row with HowlPanel as lg+ right sidebar; mobile ᚲ bell button opens bottom sheet
...
- [globals.css](development/frontend/src/app/globals.css) — `.card-chain` hover gold glow + `@media prefers-reduced-motion` rules for both `.card-chain` and `.saga-reveal`
...
- [realm-utils.ts](development/frontend/src/lib/realm-utils.ts) — `getRealmLabel()` and `getRealmDescription()`: authoritative CardStatus → Norse realm mapping
...
- [app/cards/new/layout.tsx](development/frontend/src/app/cards/new/layout.tsx) — route segment layout sets title: "Add Card"
- [app/cards/\[id\]/edit/layout.tsx](development/frontend/src/app/cards/%5Bid%5D/edit/layout.tsx) — route segment layout sets title: "Edit Card"
- [app/valhalla/layout.tsx](development/frontend/src/app/valhalla/layout.tsx) — route segment layout sets title: "Valhalla"
- [app/sign-in/layout.tsx](development/frontend/src/app/sign-in/layout.tsx) — route segment layout sets title: "Sign In"
...
- Easter Egg #2 (Konami Code Howl) — `development/frontend/src/components/layout/KonamiHowl.tsx` (↑↑↓↓←→←→BA)
