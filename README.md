...
- [quality/test-suites/settings-soft-gate/settings-soft-gate.spec.ts](quality/test-suites/settings-soft-gate/settings-soft-gate.spec.ts) — 30-test suite: PR #137 SubscriptionGate soft mode — AC-01 through AC-10, all 3 gated sections, 44px targets, Stripe checkout, regression guards
