...
- **File**: `development/frontend/src/app/api/sync/pull/route.ts:64-76`
...
- **File**: `development/frontend/src/app/api/sync/push/route.ts:85-117`
- **Category**: A01 Broken Access Control (OWASP)
...
- **File**: `development/frontend/src/app/api/household/invite/validate/route.ts:102-107`
...
- **File**: `development/frontend/src/app/api/sync/pull/route.ts`, `development/frontend/src/app/api/sync/push/route.ts`
...
- **File**: `development/frontend/src/app/api/household/join/route.ts:93-117`
...
- **File**: `development/frontend/src/lib/firebase/firestore-types.ts:110`
...
- **File**: `development/frontend/src/app/api/sync/pull/route.ts:52-60`, `development/frontend/src/app/api/sync/push/route.ts:52-65`
...
- **File**: `development/frontend/src/lib/firebase/firestore.ts`
- **Category**: INFO — positive finding
...
| `development/frontend/src/app/api/sync/route.ts` | 172 | Reviewed |
| `development/frontend/src/app/api/sync/pull/route.ts` | 98 | Reviewed |
| `development/frontend/src/app/api/sync/push/route.ts` | 140 | Reviewed |
| `development/frontend/src/app/api/household/invite/route.ts` | 111 | Reviewed |
| `development/frontend/src/app/api/household/invite/validate/route.ts` | 121 | Reviewed |
| `development/frontend/src/app/api/household/join/route.ts` | 119 | Reviewed |
| `development/frontend/src/app/api/household/members/route.ts` | 113 | Reviewed |
| `development/frontend/src/lib/firebase/firestore.ts` | 457 | Reviewed |
| `development/frontend/src/lib/firebase/firestore-types.ts` | 148 | Reviewed |
| `development/frontend/src/lib/auth/require-auth.ts` | 82 | Reviewed |
| `development/frontend/src/lib/auth/rate-limit.ts` | ~55 | Reviewed |
| `development/frontend/src/middleware.ts` | 99 | Reviewed |
| `development/frontend/src/lib/types.ts` (Card interface) | ~90 | Reviewed |
