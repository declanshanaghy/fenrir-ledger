...
- The six ingredients are hidden throughout the UI as easter eggs (see [`easter-eggs.md`](../ux/easter-eggs.md))
...
> **Loki easter egg**: Loki was the father of Fenrir. He is also the QA tester. Of course he is. See [`easter-eggs.md`](../ux/easter-eggs.md) for the Loki Mode implementation.
...
- See [`easter-eggs.md`](../ux/easter-eggs.md) for the Ragnarök threshold easter egg
