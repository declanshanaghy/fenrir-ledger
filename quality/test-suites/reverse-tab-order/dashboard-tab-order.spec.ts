...
test.describe("Dashboard Tab Order (Issue #399)", () => {
  ...
  // "AC2: default selected tab" — REMOVED (Issue #610): Duplicated by howl-panel.spec.ts.
  // "can switch between tabs" — REMOVED (Issue #610): Duplicated by dashboard-tabs TC-6.
  // "arrow right keyboard navigation" — REMOVED (Issue #610): One direction sufficient.
  // "arrow left keyboard navigation" — REMOVED (Issue #610): Keep home/end below instead.
