...
<div class="container">
  ...
  <div class="section">
    ...
    <p style="color:var(--muted);font-size:0.85rem;margin-bottom:1rem">
      Interactive HTML test reports from the last test run. Vitest requires a local HTTP server to view
      (e.g. <code>npx serve quality/reports/test-report-vitest</code>).
    </p>
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>${existsSync(path.join(REPO_ROOT, "quality/reports/test-report-vitest/index.html"))
            ? '<a href="test-report-vitest/index.html" style="color:var(--gold)">Open</a> · <code>npx serve test-report-vitest</code>'
        ...
        <tr>
          ...
          <td>${existsSync(path.join(REPO_ROOT, "quality/reports/test-report-playwright/index.html"))
            ? '<a href="test-report-playwright/index.html" style="color:var(--gold)">Open</a>'
            : '<span style="color:var(--muted)">not generated</span>'}</td>
        </tr>
      </tbody>
    </table>
