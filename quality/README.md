...
All suites live in `quality/test-suites/`. Total: **549 tests across 25 spec files**.
...
- [quality-report.md](quality-report.md) — Current quality report: 549 tests, all PASS, Stripe Direct live, Patreon removed. Recommendation: SHIP
